...
namespace TaskManagementApiAutomation.StepDefinitions
{
    ...
    public class ProjectSteps
    {
        ...
        public void WhenAPIServiceIsUpAndRunningWithPOSTEndpointProjects(string resource)
        {
            ...
            var body = JsonConvert.SerializeObject(File.ReadAllText(@"PostToProject.json"));
            
            //var actualResult = JsonConvert.SerializeObject<ProjectModel>(File.ReadAllText(@"PostToProject.json"));
            
            context.PostRequest(resource, body);
